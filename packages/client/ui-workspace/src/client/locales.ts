...
/**
 * The pt-BR dictionary: the visible chrome carries these reference labels.
 * Keys outside this table fall back to the en dictionary.
 */
export const pt = {
  'section.projects': 'Projetos',
  'section.conversations': 'Conversas e tarefas',
  'projects.pinHint': 'Fixe projetos para mantê-los aqui',
...
export const en = {
  ...
  'section.conversations': 'Conversations and tasks',
  'projects.pinHint': 'Pin projects to keep them here',
