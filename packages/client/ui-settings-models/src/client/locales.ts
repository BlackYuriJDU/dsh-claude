...
export const en = {
  ...
  profileName: 'Nome',
  profileEmail: 'Email',
  profileEmailHint: 'That email does not look valid.',
  profileContinue: 'Continuar',
  profileError: 'Could not save your profile. Try again.',
  providerTitle: 'Adicione um provedor',
  providerDescription: 'Connect a model provider with your API key to get started.',
  providerAdd: 'Adicionar provedor',
  providerLater: 'Not now',
...
/**
 * The pt-BR dictionary: onboarding and provider copy shown on first run.
 * Keys outside this table fall back to the en dictionary.
 */
export const pt = {
