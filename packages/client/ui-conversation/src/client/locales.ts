...
export const en = {
  ...
  'placeholder.hero': 'How can I help you today?',
  'placeholder.cowork': 'What shall we build?',
  ...
  'input.add': 'Add',
  'input.mic': 'Dictate',
  'input.micStop': 'Stop dictating',
  'menu.addFiles': 'Add files or photos',
  'menu.screenshot': 'Take a screenshot',
  'menu.addToProject': 'Add to project',
  'menu.github': 'Add from GitHub',
  'menu.skills': 'Skills',
...
/**
 * The pt-BR dictionary: the visible chrome the fork mirrors carries these
 * reference labels. Keys outside this table fall back to the en dictionary.
 */
export const pt = {
  'placeholder.hero': 'Como posso ajudar você hoje?',
  'placeholder.cowork': 'O que vamos construir?',
  'hero.greeting.morning': 'Bom dia',
  'hero.greeting.afternoon': 'Boa tarde',
  'hero.greeting.evening': 'Boa noite',
  'mode.label': 'Modo',
  'input.add': 'Adicionar',
  'input.mic': 'Ditar',
  'input.micStop': 'Parar ditado',
  'menu.addFiles': 'Adicionar arquivos ou fotos',
  'menu.screenshot': 'Fazer captura de tela',
  'menu.addToProject': 'Adicionar ao projeto',
  'menu.github': 'Adicionar do GitHub',
  'menu.skills': 'Habilidades',
  'menu.connectors': 'Conectores',
  'menu.webSearch': 'Busca na web',
  'menu.memory': 'Memória',
  'menu.comingSoon': 'Em breve',
  'menu.manageWorkspaces': 'Gerenciar workspaces',
  'hero.chooseWorkspace': 'Escolher workspace',
  'settings.enter.title': 'Comportamento do Enter enquanto ocupado',
  'settings.enter.description': 'Apenas quando ocupado; Cmd/Ctrl+Enter usa o outro comportamento',
