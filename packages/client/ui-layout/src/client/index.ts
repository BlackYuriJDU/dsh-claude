 ...
 * three child slots (declaration = exclusive render authority), seats the
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    // there); these three are the frame's children, declared by the same
...
export interface SidebarOwnerProps {
  ...
  collapsed: boolean
  /** Rendered navigation width in px: compact rail, desktop track, or overlay drawer. */
  width: number
}
 ...
 * into 'root' with the three child-slot declarations, the layout store seat,
