...
import { ConversationEventRegistry, ConversationNodeAssembler, SlotRegistry } from '@deepseek-ai/dsh-client-runtime/client'
import type {
...
import { fitProducedFiles, ProducedFiles, type ProducedFilesProps } from '../src/client/ProducedFiles.tsx'
import { basename, deliverablesDefinition, producedFileMentions, producedForClosing, selectProducedFiles, type DeliverablesTurnData } from '../src/client/turn-deliverables.ts'
